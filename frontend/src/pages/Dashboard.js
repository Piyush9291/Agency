...
export default function Dashboard() {
  ...
  return (
    <div className="bg-black/20 pt-20 min-h-screen" data-testid="dashboard-page">
      {/* Hero Section */}
        ...
        <div className="max-w-7xl mx-auto">
            ...
            <div className="flex flex-col md:flex-row items-start md:items-center justify-between mb-12">
              ...
              <Link to="/submit-project">
                <motion.button
                  ...
                  whileTap={{ scale: 0.95 }}
                  className="mt-6 md:mt-0 rounded-full px-8 py-4 bg-white/10 backdrop-blur-xl text-black font-bold font-jakarta flex items-center gap-3 shadow-xl hover:shadow-white/50 transition-all duration-300"
          ...
          <div className="grid md:grid-cols-3 gap-6 mb-12">
            <motion.div
              ...
              className="p-6 rounded-2xl bg-white/10 backdrop-blur-xl border border-purple-500/50"
              data-testid="stats-total-projects"
            >
              <div className="flex items-center justify-between mb-2">
                <span className="text-gray-400 font-jakarta text-sm">Total Projects</span>
            ...
            >
              <div className="flex items-center justify-between mb-2">
                <span className="text-gray-400 font-jakarta text-sm">In Progress</span>
            ...
            >
              <div className="flex items-center justify-between mb-2">
                <span className="text-gray-400 font-jakarta text-sm">Completed</span>
          ...
          {loading ? (
            ...
            >
              <div className="w-20 h-20 rounded-full bg-white/10 backdrop-blur-xl border border-purple-500/50 flex items-center justify-center mx-auto mb-6">
                <AlertCircle size={40} className="text-slate-600" />
              </div>
              <h3 className="text-2xl font-bold font-syne mb-4">No Projects Yet</h3>
              <p className="text-gray-400 font-jakarta mb-8">
                You haven't submitted any projects. Start your first project now!
              </p>
              <Link to="/submit-project">
                <button className="rounded-full px-8 py-4 bg-white/10 backdrop-blur-xl text-black font-bold font-jakarta hover:scale-105 transition-transform duration-300">
            ...
            <div className="space-y-6">
              {projects.map((project, idx) => (
                <motion.div
                  ...
                  whileHover={{ y: -3 }}
                  className="group p-6 md:p-8 rounded-3xl bg-white/10 backdrop-blur-xl border border-purple-500/50 hover:border-indigo-500/50 transition-all duration-300 cursor-pointer"
                ...
                >
                  <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
                    <div className="flex-grow">
                      ...
                      <p className="text-gray-400 font-jakarta leading-relaxed mb-4">
                        {project.description.length > 150
                          ? `${project.description.substring(0, 150)}...`
                          : project.description}
                      </p>
                      <div className="flex flex-wrap gap-4 text-sm">
                        <div className="flex items-center gap-2 text-white0 font-jakarta">
                          <Mail size={16} />
