...
export default function Contact() {
  ...
  return (
    <>
      ...
      />
      <div className="bg-black/20 pt-20" data-testid="contact-page">
      {/* Hero Section */}
            ...
            >
              {contactInfo.map((info, idx) => (
                ...
                >
                  ...
                  <a
                    href={info.link}
                    className="text-gray-400 font-jakarta hover:text-indigo-400 transition-colors duration-200"
                  >
                    {info.content}
                  </a>
                </div>
              ...
              <div className="p-6 rounded-2xl bg-gradient-to-br from-indigo-600/10 to-cyan-600/10 border border-indigo-500/20">
                ...
                <div className="space-y-2 text-gray-400 font-jakarta text-sm">
              ...
              <div className="p-8 md:p-12 rounded-3xl bg-white/10 backdrop-blur-xl border border-purple-500/50">
                ...
                <form onSubmit={handleSubmit} className="space-y-6" data-testid="contact-form">
                  ...
                  <button
                    type="submit"
                    disabled={loading}
                    className="w-full md:w-auto px-10 py-5 rounded-full bg-white/10 backdrop-blur-xl text-black font-bold font-jakarta text-lg hover:scale-105 transition-all duration-300 shadow-2xl hover:shadow-white/50 disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-3"
