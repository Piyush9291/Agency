...
export default function MarketingServices() {
  ...
  return (
    <div className="bg-black/20 pt-20" data-testid="marketing-services-page">
      {/* Hero Section */}
          ...
          <div className="grid md:grid-cols-2 gap-8">
            {services.map((service, idx) => (
              <motion.div
                ...
                className="p-8 rounded-3xl bg-white/10 backdrop-blur-xl border border-purple-500/50 hover:border-cyan-500/50 transition-all duration-300"
