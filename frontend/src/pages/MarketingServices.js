...
export default function MarketingServices() {
  ...
  return (
    <div className="bg-slate-950 pt-20" data-testid="marketing-services-page">
      {/* Hero Section */}
      <section className="py-24 md:py-32 px-6 md:px-12">
        <div className="max-w-7xl mx-auto">
          ...
          <motion.div
            ...
            className="rounded-3xl overflow-hidden border border-white/10 mb-24"
          >
            <img
          ...
          <div className="grid md:grid-cols-2 gap-8">
            {services.map((service, idx) => (
              <motion.div
                ...
                className="p-8 rounded-3xl bg-slate-900 border border-white/10 hover:border-cyan-500/50 transition-all duration-300"
