...
export default function About() {
  ...
  return (
    <>
      ...
      />
      <div className="bg-black/20 pt-20" data-testid="about-page">
      {/* Hero Section */}
      ...
      <section className="px-6 md:px-12 mb-24">
        <div className="max-w-7xl mx-auto">
          <motion.div
            ...
            viewport={{ once: true }}
            transition={{ duration: 0.6 }}
            className="rounded-3xl overflow-hidden border border-purple-500/50"
          >
            <img
      ...
      <section className="py-24 px-6 md:px-12 bg-purple-500/100">
        <div className="max-w-4xl mx-auto">
          ...
          >
            ...
            <div className="space-y-6 text-gray-400 font-jakarta leading-relaxed text-lg">
              <p>
          ...
          <div className="grid md:grid-cols-2 gap-8">
            {values.map((value, idx) => (
              ...
              >
                ...
                <p className="text-gray-400 font-jakarta leading-relaxed">{value.description}</p>
              </motion.div>
            ))}
          </div>
        </div>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            >
              <img
                ...
                alt="CEO of Kaaftek"
                className="w-full rounded-3xl border border-purple-500/50"
              />
            </motion.div>
            <motion.div
              initial={{ opacity: 0, x: 40 }}
            ...
            >
              ...
              <p className="text-gray-400 font-jakarta leading-relaxed text-lg mb-6">
              ...
              <div>
                ...
                <p className="text-gray-400 font-jakarta">CEO & Founder</p>
              </div>
            </motion.div>
          </div>
        </div>
