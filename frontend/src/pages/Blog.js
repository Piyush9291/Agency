    ...
    <>
      ...
      <section className="pb-24 px-6 md:px-12">
        <div className="max-w-7xl mx-auto">
          ...
          >
            <div className="grid md:grid-cols-2 gap-8 rounded-3xl overflow-hidden bg-white border border-gray-200/50 hover:border-indigo-500/50 transition-all duration-300">
            ...
            {categories.map((category, idx) => (
              <motion.button
                ...
                className={`px-6 py-3 rounded-full font-jakarta font-semibold transition-all duration-300 ${
                  idx === 0
                    ? "bg-gradient-to-r from-purple-600 to-teal-500 text-gray-900"
                    : "bg-white text-gray-600 border border-gray-200/50 hover:border-indigo-500/50 hover:text-gray-900"
                }`}
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {blogPosts.map((post, idx) => (
              ...
              >
                <div className="rounded-2xl overflow-hidden bg-white border border-gray-200/50 hover:border-indigo-500/50 transition-all duration-300 h-full flex flex-col">
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row gap-4 max-w-md mx-auto">
              <input
                ...
                className="flex-grow px-6 py-4 rounded-full bg-gray-50 border border-gray-200/50 focus:border-indigo-500 focus:outline-none focus:ring-2 focus:ring-indigo-500/50 text-gray-900 font-jakarta"
