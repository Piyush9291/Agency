...
export default function Blog() {
  ...
  return (
    <>
      ...
      />
      <div className="bg-black/20 pt-20" data-testid="blog-page">
      {/* Hero Section */}
      ...
      <section className="pb-24 px-6 md:px-12">
        <div className="max-w-7xl mx-auto">
          ...
          >
            <div className="grid md:grid-cols-2 gap-8 rounded-3xl overflow-hidden bg-white/10 backdrop-blur-xl border border-purple-500/50 hover:border-indigo-500/50 transition-all duration-300">
              ...
              <div className="p-8 md:p-12 flex flex-col justify-center">
                ...
                <div className="flex items-center justify-between text-sm text-white0 font-jakarta mb-6">
              ...
              <motion.button
                ...
                className={`px-6 py-3 rounded-full font-jakarta font-semibold transition-all duration-300 ${
                  idx === 0
                    ...
                    : "bg-white/10 backdrop-blur-xl text-gray-400 border border-purple-500/50 hover:border-indigo-500/50 hover:text-white"
                }`}
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {blogPosts.map((post, idx) => (
              ...
              >
                <div className="rounded-2xl overflow-hidden bg-white/10 backdrop-blur-xl border border-purple-500/50 hover:border-indigo-500/50 transition-all duration-300 h-full flex flex-col">
                  ...
                  <div className="p-6 flex flex-col flex-grow">
                    ...
                    <p className="text-gray-400 font-jakarta text-sm mb-4 flex-grow">
                      {post.excerpt}
                    </p>
                    <div className="flex items-center justify-between text-xs text-white0 font-jakarta mb-4">
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row gap-4 max-w-md mx-auto">
              <input
                ...
                className="flex-grow px-6 py-4 rounded-full bg-black/20 border border-purple-500/50 focus:border-indigo-500 focus:outline-none focus:ring-2 focus:ring-indigo-500/50 text-white font-jakarta"
                data-testid="newsletter-email-input"
              />
              <button
                className="px-8 py-4 rounded-full bg-white/10 backdrop-blur-xl text-black font-bold font-jakarta hover:scale-105 transition-transform duration-300 whitespace-nowrap"
