          ...
          <div className="grid md:grid-cols-2 gap-8">
            {bestServices.map((service, idx) => (
              ...
              >
                ...
                <div className="relative p-8 rounded-3xl bg-white/90 border border-gray-200/50 hover:border-indigo-500/50 transition-all duration-300 backdrop-blur-sm h-full">
                  ...
                  <Link to="/submit-project">
                    <button className="w-full rounded-full px-6 py-3 bg-gray-50 hover:bg-white/10 border border-gray-200/50 hover:border-indigo-500/50 transition-all duration-300 font-semibold font-jakarta flex items-center justify-center gap-2 group">
                      Get Started
