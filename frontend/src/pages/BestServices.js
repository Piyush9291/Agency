...
export default function BestServices() {
  ...
  return (
    <div className="bg-slate-950 pt-20" data-testid="best-services-page">
      {/* Hero Section */}
          ...
          <div className="grid md:grid-cols-2 gap-8">
            {bestServices.map((service, idx) => (
              ...
              >
                ...
                <div className="relative p-8 rounded-3xl bg-slate-900/90 border border-white/10 hover:border-indigo-500/50 transition-all duration-300 backdrop-blur-sm h-full">
                  ...
                  <ul className="space-y-3 mb-6">
                    {service.features.map((feature, fIdx) => (
                      <li key={fIdx} className="flex items-center text-slate-300 font-jakarta">
                  ...
                  <Link to="/submit-project">
                    <button className="w-full rounded-full px-6 py-3 bg-white/5 hover:bg-white/10 border border-white/10 hover:border-indigo-500/50 transition-all duration-300 font-semibold font-jakarta flex items-center justify-center gap-2 group">
                      Get Started
