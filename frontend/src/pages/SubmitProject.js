    ...
    return (
      <div className="bg-gray-50 min-h-screen flex items-center justify-center px-6" data-testid="submit-project-success">
        <motion.div
          ...
          className="max-w-2xl w-full p-12 rounded-3xl bg-white border border-gray-200/50 text-center"
        >
    ...
    <>
      ...
      <section className="py-24 md:py-32 px-6 md:px-12">
        <div className="max-w-4xl mx-auto">
          ...
          >
            <div className="p-8 md:p-12 rounded-3xl bg-white border border-gray-200/50">
              <form onSubmit={handleSubmit} className="space-y-8" data-testid="project-form">
                ...
                <div className="grid md:grid-cols-2 gap-6">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full px-6 py-4 rounded-xl bg-gray-50/50 border border-gray-200/50 focus:border-indigo-500 focus:outline-none focus:ring-2 focus:ring-indigo-500/50 text-gray-900 font-jakarta transition-all duration-200"
                ...
                <div>
                  ...
                  <textarea
                    ...
                    onChange={handleChange}
                    rows="6"
                    className="w-full px-6 py-4 rounded-xl bg-gray-50/50 border border-gray-200/50 focus:border-indigo-500 focus:outline-none focus:ring-2 focus:ring-indigo-500/50 text-gray-900 font-jakarta resize-none transition-all duration-200"
