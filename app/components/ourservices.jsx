    ...
    <section className="min-h-screen bg-gradient-to-br from-gray-50 via-white to-purple-50 py-16 px-4 sm:px-8 lg:px-16 font-inter">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-14">
          ...
          <h2 className="text-3xl sm:text-4xl md:text-5xl font-heading font-bold text-gray-800 mt-6 leading-tight">
            Our Best Services
          </h2>
        </div>
                ...
                >
                  ...
                  <div className="relative z-10 flex-1 flex flex-col">
                    <div className="flex items-start justify-between mb-6">
                      <h3 className="text-xl sm:text-2xl font-heading font-bold text-white leading-tight pr-4">
                        {service.title}
                      </h3>
                    ...
                    <p className="text-white/90 text-sm sm:text-base font-body leading-relaxed mb-6 line-clamp-3">
                      {service.description}
                    </p>

                    <div className="flex items-center justify-between mt-auto">
                      <div className="text-white font-secondary font-semibold text-sm sm:text-base inline-flex items-center group-hover:translate-x-1 transition-transform duration-300">
                        Read More
