    ...
    <div className="font-poppins">
      ...
      <section className="bg-white">
        <div className="w-full text-center py-12 sm:py-16 md:py-20 lg:py-24 px-4 bg-gradient-to-r from-[#f3f0f3] to-[#dcbae8]">
          <h1 className="text-xl sm:text-2xl md:text-3xl lg:text-4xl xl:text-5xl font-extrabold tracking-tight drop-shadow-md text-transparent bg-clip-text bg-gradient-to-r from-[#199db2] via-[#2D3363] to-[#d2276e] leading-tight">
            SEO Agency<br /> in Delhi
          </h1>
          <p className="mt-4 sm:mt-6 text-sm sm:text-base md:text-lg lg:text-xl font-medium text-slate-600 max-w-4xl mx-auto leading-relaxed">
            Looking for a trusted SEO company in Pune that delivers measurable results? Itorix Infotech offers customized SEO services in Pune designed to improve your search rankings, drive organic traffic, and enhance brand visibility.
          </p>
        </div>
        <img
          src="/SEO.webp"
      ...
      <section className="bg-white px-4 py-8 sm:py-12 md:py-16 lg:py-20 font-sans text-center">
        <div className="max-w-4xl mx-auto text-center space-y-6">
          <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-extrabold text-gray-900 tracking-tight">
            Why Choose Itorix Infotech as an SEO Agency in Pune?
          </h1>
          <p className="text-base sm:text-lg md:text-xl text-gray-700 leading-relaxed">
            As a leading SEO agency in Pune, we provide results-driven SEO services tailored to your business goals.
          </p>
        </div>
        <div className="mt-10 max-w-3xl mx-auto space-y-8">
          <div className="space-y-2">
            ...
            <p className="text-gray-700 text-sm sm:text-base leading-relaxed">
              Our team has successfully executed SEO campaigns for real estate, healthcare, education, manufacturing, B2B,
              startups, and more.
            </p>
          </div>
          <div className="space-y-2">
            ...
            <p className="text-gray-700 text-sm sm:text-base leading-relaxed">
              We create personalized SEO plans based on your industry, competition, and target audience for long-term
              growth.
            </p>
          </div>
          <div className="space-y-2">
            ...
            <p className="text-gray-700 text-sm sm:text-base leading-relaxed">
              Get detailed SEO reports with key metrics like rankings, traffic, and conversions—no hidden surprises.
            </p>
          </div>
        </div>
      </section>
